...
export class SettingsController {
  ...
  async getPublic() {
    ...
    return {
      ...
      register_phone_required: all.register_phone_required || "false",
      register_address_required: all.register_address_required || "false",
      register_postalcode_required: all.register_postalcode_required || "false",
